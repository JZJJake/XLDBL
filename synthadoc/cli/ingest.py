...
@app.command("ingest")
def ingest_cmd(
    source: Optional[str] = typer.Argument(None, help="中文提示"),
    batch: bool = typer.Option(False, "--batch/--no-batch", help="中文提示"),
    file: Optional[str] = typer.Option(None, "--file", help="中文提示"),
    force: bool = typer.Option(False, "--force", help="中文提示"),
