...
jobs_app = typer.Typer(help="中文提示")
app.add_typer(jobs_app, name="jobs")


@jobs_app.command("list")
def jobs_list(
    status: Optional[str] = typer.Option(None, "--status", help="中文提示"),
...
def jobs_status(
    job_id: str = typer.Argument(..., help="中文提示"),
    wiki: Optional[str] = typer.Option(None, "--wiki", "-w"),
):
...
def jobs_cancel(
    wiki: Optional[str] = typer.Option(None, "--wiki", "-w"),
    yes: bool = typer.Option(False, "--yes", "-y", help="中文提示"),
):
