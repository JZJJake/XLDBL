...
staging_app = typer.Typer(name="staging", help="中文提示")
candidates_app = typer.Typer(name="candidates", help="中文提示")
...
def staging_policy_cmd(
    policy: Optional[str] = typer.Argument(None, help="中文提示"),
    min_confidence: Optional[str] = typer.Option(None, "--min-confidence"),
    wiki: Optional[str] = typer.Option(None, "--wiki", "-w", help="中文提示"),
) -> None:
