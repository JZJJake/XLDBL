...
context_app = typer.Typer(name="context", help="中文提示")
...
def context_build(
    goal: str = typer.Argument(..., help="中文提示"),
    tokens: int = typer.Option(4000, "--tokens", help="中文提示"),
    output: Optional[str] = typer.Option(None, "--output", help="中文提示"),
